...
from basic_net import BasicNet1  # Importing the model class directly
from learner_task_itaml import Learner  # Importing Learner class for incremental learning
import incremental_dataloader as data  # Importing data handler

class args:

    checkpoint = "results/cifar10poison/meta2_cifar_T10_71"
    savepoint = "models/" + "/".join(checkpoint.split("/")[1:])
    data_path =  "C:/Users/justi/PycharmProjects/iTAML_ATK_Mk1/poisoned_datasets" # simply use "poisoned_datasets" for adversarial attacks
    num_class = 10
    class_per_task = 2
    num_task = 5
